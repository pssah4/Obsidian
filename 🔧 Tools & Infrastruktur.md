...
columns:
  ...
  Nutzung:
    ...
    isSortedDesc: true
    options:
      - { label: "Watchlist", value: "Watchlist", color: "hsl(55,100%,87%)"}
      - { label: "Test", value: "Test", color: "hsl(197,86%,89%)"}
      - { label: "Aktiv", value: "Aktiv", color: "hsl(114,100%,86%)"}
      - { label: "Inaktiv", value: "Inaktiv", color: "hsl(0,0%,94%)"}
      - { label: "Keine", value: "Keine", color: "hsl(0,94%,94%)"}
      - { label: "Nein", value: "Nein", color: "hsl(251, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
...
config:
  ...
  current_row_template: Obsidian Notes/Templates/Tool Template.md
  pagination_size: 200
  font_size: 12
